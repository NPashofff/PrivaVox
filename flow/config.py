...
class FlowConfig:
    ...
    # direct-typing insertion (remote sessions): pause between 20-char Unicode
    # keystroke chunks — RDP forwards each event over the network, so a small
    # gap keeps ordering reliable without being humanly slow
