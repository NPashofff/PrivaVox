...
if IS_MAC:
    ...
    def paste_remote(text: str, config=None) -> str:  # noqa: ARG001
        """Remote-session paste is a mac-side feature (win32 dictates locally)."""
        set_clipboard(text)
        return "clipboard-only"

__all__ = ["paste_text", "paste_remote", "get_clipboard", "set_clipboard",
           "can_post_events", "type_text"]
