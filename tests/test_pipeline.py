...
def test_hallucination_filter_known_phrases() -> None:
    for phrase in ("Thank you.", " Благодаря. ", "Субтитри от МЕДИЯ ТРАНС", ".", "", "  ?! ",
                   # Russian subtitle-credit hallucinations (names vary, appear anywhere)
                   "Редактор субтитров А.Семкин Корректор А.Егорова",
                   "субтитры сделал Иван", "Subtitles by the Amara.org community"):
    ...
    for phrase in ("Thank you for the report, Maria.", "Благодаря ти за доклада.",
                   # genuine Bulgarian words that must NOT be filtered:
                   "Коректорът провери текста",   # bg "коректор" (single р, not RU "корректор")
                   "Редакторът ми каза да го напиша"):
